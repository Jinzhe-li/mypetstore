...
public class Cart implements Serializable {
  ...
  public void addItem(Item item, boolean isInStock,String userid) {
    ...
    if (cartItem == null) {
      ...
      cartService.insertCart(cartItem,userid);
    }
    cartItem.incrementQuantity();
    cartService.updateCart(cartItem,userid);
  }
  ...
  public Item removeItemById(String itemId,String userid) {
    ...
    if (cartItem == null) {
      ...
      CartService cartService = new CartService();
      cartService.deleteCart(cartItem,userid);
