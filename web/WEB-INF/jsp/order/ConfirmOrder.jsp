...
<div id="BackLink"><a href="${pageContext.request.contextPath}/main">
	Return to Main Menu
	</a></div>
...
<table>
	<tr>
		...
		<br />
		<font size="3"><b> <c:out value="${sessionScope.order.orderDate}" /></b></font>
		</th>
	</tr>
...
<a href="${pageContext.request.contextPath}/order?orders=4"><button type="button" >Confirm</button></a>
